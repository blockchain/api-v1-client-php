...
If you are adding this project as a library or third party plugin to your application, no need downloading the source you may rather find it more convenient to use the code below : 
