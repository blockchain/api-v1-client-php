...
class Explorer
{
    ...
    public function getBase58Address($address, $limit = 50, $offset = 0, $filter = FilterType::REMOVE_UNSPENDABLE)
    {
        return $this->getAddress($address, $limit, $offset, $filter);
    }

    public function getHash160Address($address, $limit = 50, $offset = 0, $filter = FilterType::REMOVE_UNSPENDABLE)
    {
        return $this->getAddress($address, $limit, $offset, $filter);
    }
    ...
    /*     Get details about a single address, listing up to $limit transactions
         starting at $offset.
    */
    public function getAddress($address, $limit = 50, $offset = 0, $filter = FilterType::REMOVE_UNSPENDABLE)
    {
        $params = array(
            'format'=>'json',
            'limit'=>intval($limit),
    ...
    public function getXpub($xpub, $limit = 100, $offset = 0, $filter = FilterType::REMOVE_UNSPENDABLE)
    {
        $params = array(
            'format'=>'json',
            'limit'=>intval($limit),
    ...
    public function getMultiAddress($addresses, $limit = 100, $offset = 0, $filter = FilterType::REMOVE_UNSPENDABLE)
    {
